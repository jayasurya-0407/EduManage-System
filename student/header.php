    ...
    <style>
        * {
        ...
        .profile-avatar:hover {
            box-shadow: 0 0 0 3px rgba(111, 76, 255, .65);
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="sNav">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-3" style="gap:.35rem;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?= $current_page == 'browse_courses.php' ? 'active' : '' ?>"
                            href="browse_courses.php">
                            Explore Courses
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <div class="profile-dropdown" id="profileDropdown">
                        ...
                        <div class="pd-header">
                            ...
                            <div style="overflow:hidden;">
                                <div class="pd-name"><?= htmlspecialchars($_SESSION['student_name'] ?? 'Student') ?>
                                </div>
                        ...
                        <div class="pd-menu">
                            ...
                            <a href="support.php" class="pd-item">
